        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          ...
          <Card className="bg-white border border-slate-200 card-hover">
            <CardContent className="p-4 flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-slate-900">{stats.docs_da_verificare || 0}</p>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="stats">
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="bg-white border border-slate-200">
                <CardHeader>
                  <CardTitle className="font-heading text-lg">Riepilogo Scadenze</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-amber-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-slate-700">Da fare</span>
                      </div>
                      <span className="text-2xl font-bold text-amber-700">{stats.deadlines_da_fare || 0}</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <Clock className="h-5 w-5 text-blue-600" />
                        <span className="text-slate-700">In lavorazione</span>
                      </div>
                      <span className="text-2xl font-bold text-blue-700">{stats.deadlines_in_lavorazione || 0}</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <CheckCircle2 className="h-5 w-5 text-green-600" />
                        <span className="text-slate-700">Completate</span>
                      </div>
                      <span className="text-2xl font-bold text-green-700">{stats.deadlines_completate || 0}</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <AlertTriangle className="h-5 w-5 text-red-600" />
                        <span className="text-slate-700">Scadute</span>
                      </div>
                      <span className="text-2xl font-bold text-red-700">{stats.deadlines_scadute || 0}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border border-slate-200">
                <CardHeader>
                  <CardTitle className="font-heading text-lg">Riepilogo Documenti</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                      ...
                      <span className="text-2xl font-bold text-purple-700">{stats.docs_da_verificare || 0}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
