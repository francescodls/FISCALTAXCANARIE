...
const DocumentFolderBrowser = ({ clientId, token, userRole = "commercialista", onDocumentView }) => {
                    ...
                    {folder.documents.map((doc) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          {(userRole === "commercialista" || userRole === "cliente") && (
                            <Button
                              variant="ghost"
                              size="icon"
